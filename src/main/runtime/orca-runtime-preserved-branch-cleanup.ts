...
export class OrcaRuntimeWithPreservedBranchCleanup extends OrcaRuntimeWithTerminalDrivers {
  ...
  protected readonly resolveWindowProjectGroupIdFn: ((windowId: number) => string | null) | null

  protected readonly onPtyOwnerWindowsChanged: ((changes: PtyOwnerWindowChange[]) => void) | null
