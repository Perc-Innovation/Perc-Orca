...
import type { MainWindowOpenOptions } from './startup/main-window-actions'
...
function openMainWindow(options: MainWindowOpenOptions = {}): BrowserWindow {
...
function publishOsOpenedMarkdownFiles(): void {
  // Why the registry: with several windows the one to receive a Finder "Open With" is the one in front.
