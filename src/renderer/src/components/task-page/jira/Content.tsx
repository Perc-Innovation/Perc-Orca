...
import { getJiraViewOptions } from '@/components/task-page-localized-options'
...
export function TaskPageJiraContent({
  ...
  const {
    ...
    getJiraIssueAttachedWorkspace,
    handleJiraBoardMoveIssue,
    handleOpenOrUseJiraItem,
    handleUseJiraItem
  } = model
        ...
        <div className="flex h-10 flex-none items-center justify-between gap-3 border-b border-border/50 bg-muted/35 px-3">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <div
              ...
              aria-label={translate('auto.components.TaskPage.jiraViewMode', 'Jira view mode')}
            >
