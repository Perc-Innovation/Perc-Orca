...
import { useTaskPageJiraFilterState } from '../use-task-page-jira-filter-state'
...
import { useTaskPageJiraFilterEffects } from '../use-task-page-jira-filter-effects'
...
export default function TaskPage(): React.JSX.Element {
  ...
  const stage12a = useTaskPageJiraFilterState(stage12)
  const stage13 = useTaskPageResumeRestoration(stage12a)
  ...
  const stage19a = useTaskPageJiraBoard(stage19)
  const stage20 = useTaskPageLinearCreationState(stage19a)
  ...
  const stage38a = useTaskPageJiraFilterEffects(stage38)
  const stage39 = useTaskPageComposerActions(stage38a)
