  ...
  return (
    <>
      <div className="mt-2 flex h-9 min-w-0 items-center justify-between gap-1.5 px-2">
        ...
        {!agentsViewActive && scopedProject.scope ? (
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <span
                className="flex min-w-0 flex-1 items-center gap-1.5 px-1 text-xs font-semibold text-muted-foreground/80 select-none"
