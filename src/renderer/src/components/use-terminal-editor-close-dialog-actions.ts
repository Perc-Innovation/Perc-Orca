...
export function useTerminalEditorCloseDialogActions(
  ...
  // Why: main is holding the window open for this dialog; dropping the pending close without
  // saying so leaves main waiting on a confirmation that never comes.
